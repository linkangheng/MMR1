...
from open_r1.constants import reward_funcs_registry, system_prompt_registry, question_template_registry, answer_template_registry, temperature_func_registry
