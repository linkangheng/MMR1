...
def load_image(image_path):
    ...
    if 's3://' in image_path:
        with megfile.smart_open(image_path, "rb") as f:
            bytes_data = f.read()
        image = PILImage.open(BytesIO(bytes_data), "r")
    else:
...
# define the formats 
input_file = '/mnt/shared-storage/groups/hypertext/sft-data/jihe/molmo-merged-239304.json'
...
train_save_path = "/mnt/jfs-test/data/lucas_counting/molmo-50k"
